...
public interface DamagedMapper {
    ...
    int updateByExampleSelective(@Param("record") Damaged record, @Param("example") DamagedExample example);

    int updateByExample(@Param("record") Damaged record, @Param("example") DamagedExample example);
